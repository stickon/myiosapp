...
-(instancetype)initWithName:(NSString*)deviceName ID:(NSString*)deviceID IP:(NSString*)deviceIP
{
    if (self = [super init]) {
        ...
        groupDelayTime = NULL;
        groupBlowTime = NULL;
        groupEjectorType = NULL;
        groupUseCenterPoint = NULL;
        groupOpenValveTime = NULL;
        groupValveWorkMode = NULL;
        
        
        groupSenseSize = NULL;
        groupSharpenCKValue = NULL;
        groupmirrorCKValue = NULL;
...
-(void)dealloc{
    ...
    free(groupOpenValveTime);
    free(groupValveWorkMode);
    free(groupDelayTime);
    free(groupBlowTime);
    free(groupEjectorType);
    free(groupUseCenterPoint);
    ...
    free(groupSenseSize);
    free(groupSharpenCKValue);
    free(groupmirrorCKValue);
}
