...
-(void)layoutSubviews{
    ...
    [self.senseValueTitle setFrame:CGRectMake(width/5*1-10, 4, 70, 40)];
    [self.senseLightUpperLimitValue setFrame:CGRectMake(width/5*2-10, 4, 70, 40)];
    [self.senseLightLowerLimitValue setFrame:CGRectMake(width/5*3-10, 4, 70, 40)];
    [self.reverseTitle setFrame:CGRectMake(width/5*4-10, 4, 70, 40)];
}
