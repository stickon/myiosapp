...
- (void)awakeFromNib {
    ...
    self.colorSenseChuteNumLabel.font = SYSTEMFONT_14f;
    self.colorSenseValueTextField.font = SYSTEMFONT_14f;
    self.colorSenseLightUpperLimitValueTextField.font = SYSTEMFONT_14f;
    self.colorSenseLightLowerLimitValueTextField.font = SYSTEMFONT_14f;
}
