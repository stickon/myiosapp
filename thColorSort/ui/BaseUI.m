...
- (void)logOut {
    ...
    if (device) {
        if (device->machineData.cleanState != 0) {
            [self cleanTimeOut];
        }
    }
...
- (void)initLanguage
{
    _shapeArray = @[@"",kLanguageForKey(155),kLanguageForKey(156),kLanguageForKey(157),kLanguageForKey(158),kLanguageForKey(159),kLanguageForKey(160),kLanguageForKey(161),kLanguageForKey(162),kLanguageForKey(163),kLanguageForKey(164),kLanguageForKey(165),kLanguageForKey(166),kLanguageForKey(167),kLanguageForKey(168),kLanguageForKey(169),kLanguageForKey(170),kLanguageForKey(171),kLanguageForKey(172),kLanguageForKey(173),[NSString stringWithFormat:@"%@%@",kLanguageForKey(167),kLanguageForKey(284)],kLanguageForKey(901),kLanguageForKey(902)];
}
    ...
    if (!_layerChangeView) {
        ...
        if (device) {
            if (device->machineData.layerNumber <3) {
               ...
               array = @[kLanguageForKey(140),kLanguageForKey(141),kLanguageForKey(139),kLanguageForKey(140),kLanguageForKey(141),kLanguageForKey(139),kLanguageForKey(131),kLanguageForKey(130)];
            }else if (device->machineData.layerNumber >3){
...
- (void)tipsUpdateLanguage{
    [self.window makeToast:kLanguageForKey(255) duration:2.0 position:CSToastPositionCenter];
}
@end
