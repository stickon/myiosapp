...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1) {
        ...
        else
        {
            ...
            if (device->SortBelongToGroup[index-1] == 0){
                cell.chuteTitleLabel.textColor = [UIColor Group1Color];
            }
            if (device->SortBelongToGroup[index-1] == 1){
                cell.chuteTitleLabel.textColor = [UIColor Group2Color];
            }
            if (device->SortBelongToGroup[index-1] == 2){
                cell.chuteTitleLabel.textColor = [UIColor Group3Color];
            }
            if (device->SortBelongToGroup[index-1] == 3){
                cell.chuteTitleLabel.textColor = [UIColor Group4Color];
            }
    ...
    if (indexPath.section == 2) {
        ...
        if(indexPath.row == 0)
        {
            ...
            int index = (int)indexPath.row;
            if (device->SortBelongToGroup[index-1] == 0){
                cell.chuteIndexLabel.textColor = [UIColor Group1Color];
            }
            if (device->SortBelongToGroup[index-1] == 1){
                cell.chuteIndexLabel.textColor = [UIColor Group2Color];
            }
            if (device->SortBelongToGroup[index-1] == 2){
                cell.chuteIndexLabel.textColor = [UIColor Group3Color];
            }
            if (device->SortBelongToGroup[index-1] == 3){
                cell.chuteIndexLabel.textColor = [UIColor Group4Color];
            }
