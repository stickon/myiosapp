        ...
        if (indexPath.row == 0) {
            ...
            if (self.signalType == 0) {//灯光背景灯cell
                ...
                if (device->screenProtocolType == 2) {//1R大米机
                    ...
                    cell.BlueTitleLabel.hidden = YES;
                    cell.redTextField.hidden = YES;
                    cell.rearRedTextField.hidden = YES;
                    cell.blueTextField.hidden = YES;
                    cell.rearBlueTextField.hidden = YES;
                }else{
                    cell.RedTitleLabel.hidden = NO;
                    cell.GreenTitleLabel.hidden = NO;
                    cell.BlueTitleLabel.hidden = NO;
                }
