    ...
    if (indexPath.section ==0) {
        if (indexPath.row == 0) {
            ...
            if (device->SortBelongToGroup[indexPath.row-1] == 0){
                cell.feedCellTitle.textColor = [UIColor Group1Color];
            }
            if (device->SortBelongToGroup[indexPath.row-1] == 1){
                cell.feedCellTitle.textColor = [UIColor Group2Color];
            }
            if (device->SortBelongToGroup[indexPath.row-1] == 2){
                cell.feedCellTitle.textColor = [UIColor Group3Color];
            }
            if (device->SortBelongToGroup[indexPath.row-1] == 3){
                cell.feedCellTitle.textColor = [UIColor Group4Color];
            }
        ...
        if (indexPath.row == 0) {
            ...
            if (device->machineData.vibOut>1) {
                ...
                if (device->machineData.machineType == MACHINE_TYPE_CHUTE && (device->machineData.chuteNumber == 1 ||device->machineData.chuteNumber == 2)) {
                    cell.feedNumTextField.hidden = NO;
