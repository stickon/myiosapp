...
//  thColorSort
//
//  Created by huanghu on 2018/1/18.
...
-(void)updateView{
    ...
    if (device->peanutbud3.isHasSecond) {
        if (self.groupView->groupNum != 2){
            [self.groupView setGroupNum:2 Title:[NSArray arrayWithObjects:kLanguageForKey(331),kLanguageForKey(332), nil] SelectedIndex:0];
        }
